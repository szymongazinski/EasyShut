...
$gui = @('/target:winexe', "/out:$out\EasyShut-window.exe", '/reference:System.Windows.Forms.dll', '/reference:System.Drawing.dll', "/resource:$repo\assets\EasyShut.ico,EasyShut.App.ico", "/resource:$repo\assets\EasyShut-black.ico,EasyShut.App.black.ico") + $sources + @("$repo\src\Gui.cs", "$repo\src\HelpWindow.cs", "$repo\src\AdvancedWindow.cs", "$repo\src\AppIcon.cs", "$repo\src\AppIdentity.cs")
...
if (-not $TestBuild) {
    ...
    $setupFlags += @("/win32icon:$repo\assets\EasyShut.ico", "/resource:$repo\assets\EasyShut.ico,EasyShut.App.ico", "/resource:$repo\assets\EasyShut-black.ico,EasyShut.App.black.ico")
