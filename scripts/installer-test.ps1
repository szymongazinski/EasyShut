...
& $compiler /nologo /warnaserror+ /utf8output /codepage:65001 /langversion:5 /target:exe /reference:Microsoft.CSharp.dll "/reference:$out\EasyShut-Setup.exe" "/out:$out\installer-tests.exe" "$repo\tests\InstallerTests.cs"
