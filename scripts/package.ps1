...
$stage = Join-Path $dist 'EasyShut-1.2.3-windows'
...
$zip = Join-Path $dist 'EasyShut-1.2.3-windows.zip'
...
$hashes = foreach ($name in @('EasyShut-1.2.3-windows.zip', 'EasyShut-Setup.exe')) {
