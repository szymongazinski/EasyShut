...
$stage = Join-Path $dist 'EasyShut-1.1.0-windows'
...
$zip = Join-Path $dist 'EasyShut-1.1.0-windows.zip'
...
$hashes = foreach ($name in @('EasyShut-1.1.0-windows.zip', 'EasyShut-Setup.exe')) {
