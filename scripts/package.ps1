...
$stage = Join-Path $dist 'EasyShut-1.2.2-windows'
...
$zip = Join-Path $dist 'EasyShut-1.2.2-windows.zip'
...
$hashes = foreach ($name in @('EasyShut-1.2.2-windows.zip', 'EasyShut-Setup.exe')) {
